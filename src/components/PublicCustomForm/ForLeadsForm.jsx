  ...
  const onSubmit = async (e) => {
    ...
    await dispatch(
      createLead({
        ...
        real_status: data.find((item) => item.name === "ordered").id,
        instrument: instruments.find((item) => item.name === "office").code,
      })
    );
    onClose();
